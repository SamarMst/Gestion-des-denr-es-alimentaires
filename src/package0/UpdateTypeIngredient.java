...
public class UpdateTypeIngredient extends JFrame {
    ...
    TypeIngredientDAO ty = null;
			...
			public UpdateTypeIngredient() {
				...
				JLabel lblNewLabel_1 = new JLabel("Update Type Ingredient");
				...
				btnNewButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if(r==btnNewButton) {
							...
							TypeIngredient rr = new TypeIngredient(t1,t2);
							
							boolean k =ty.update(rr);
							System.out.println(k);
							JOptionPane.showMessageDialog(null, "Update avec Succes !","Update Type Ingredient",JOptionPane.INFORMATION_MESSAGE);
							setVisible(false);
						}
					}});
