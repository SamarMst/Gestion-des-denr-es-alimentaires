...
import javax.swing.JTextField;
	...
	public class DeleteTypeIngredient extends JFrame {
		    ...
		    TypeIngredientDAO ty = null;
					...
					public DeleteTypeIngredient() {
						...
						lblNewLabel.setBounds(25, 135, 164, 28);
						...
						JLabel lblNewLabel_1 = new JLabel("Delete Type Ingredient");
						...
						btnNewButton.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent e) {
								...
								if(r==btnNewButton) {
									...
									TypeIngredient d = ty.find(h);
									ty.delete(d);
									
									JOptionPane.showMessageDialog(null, "Delete avec Succes !","Delete Type Ingredient",JOptionPane.INFORMATION_MESSAGE);
									setVisible(false);
								}
							}});
					}
