...
import javax.swing.JTextField;
	...
	public class CreateRecette extends JFrame  {
		...
		public RecetteDAO rcd1=null;

					/**
					 * Create the frame.
					 */
					
					public CreateRecette() {
						setVisible(true);
						...
						JLabel lblNewLabel_1 = new JLabel("Créer Recette");
						...
						public void actionPerformed(ActionEvent e) {
							...
							JButton r=(JButton)q;
							if(r==btnNewButton) {
								Recette w=new Recette(t1,t2,t3,t4,t5,t6,t7,t8);
								try {
								...
								rcd1.create(w);
								JOptionPane.showMessageDialog(null, "Ajout avec Succes !","Creation Recette",JOptionPane.INFORMATION_MESSAGE);
								setVisible(false);
							}
